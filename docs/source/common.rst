...
برای دریافت لیست شهرها از این وب‌سرویس استفاده کنید:
...
برای دریافت لیست استان‌ها از این وب‌سرویس استفاده کنید:
...
برای دریافت لیست شرکت‌های بیمه از این وب‌سرویس استفاده کنید:
...
برای دریافت لیست انواع خودرو از این وب‌سرویس استفاده کنید:
...
``page``، ``size``، ``vehicle_group_code``، ``vehicle_system_code`` و ``search``
...
برای دریافت لیست انواع پلاک از این وب‌سرویس استفاده کنید:
...
``page``، ``size`` و ``vehicle_group_code``
...
برای دریافت لیست کدهای پلاک از این وب‌سرویس استفاده کنید:
...
برای دریافت لیست موارد استفاده خودرو از این وب‌سرویس استفاده کنید:
...
برای دریافت لیست گروه‌های خودرو از این وب‌سرویس استفاده کنید:
...
برای دریافت لیست سیستم‌های خودرو از این وب‌سرویس استفاده کنید:
...
``page``، ``size``، ``vehicle_group_code`` و ``search``
...
برای دریافت لیست انواع سوخت از این وب‌سرویس استفاده کنید:
...
برای دریافت لیست رنگ‌ها از این وب‌سرویس استفاده کنید:
